...
import com.metro.metro.domain.subway.Route;
import com.metro.metro.domain.subway.Station;
import com.metro.metro.domain.subway.UnderGround;

public class UnderGroundMedellin {

	private Station[] stations = new Station[15];

	private UnderGround underGround = new UnderGround();

	public UnderGroundMedellin() {
